...
const RevealStaggeredText = ({ children }) => {
  return (
    <motion.p
      initial="initial"
      whileHover="hovered"
      className="relative block overflow-hidden whitespace-nowrap text-[2vw] font-black uppercase sm:text-7xl md:text-8xl lg:text-9xl"
      style={{
        lineHeight: 0.75,
      }}
    >
...
export default RevealStaggeredText;